...
const Navbar = () => {
 ...
 const cartQuantity = useSelector(selectCartTotalQuantity);
  ...
  useEffect(() => {
    setShowCartButton(location.pathname === '/labs' || location.pathname === '/medifarma');
  }, [location.pathname]);
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex-shrink-0 flex items-center">
              <Link to="/" className="flex items-center">
                <img
                  className="h-14 w-auto aspect-auto transition-transform duration-300 hover:scale-110"
            ...
            <div className="block md:hidden flex-1 max-w-sm mx-4">
              ...
              <div className="flex items-center justify-center space-x-3 bg-gray-100 rounded-full px-3 py-1">
                ...
                <div className="relative">
                  ...
                  >
                    Medifarma
                    {/* <svg
                      className={`ml-1 h-4 w-4 transition-transform duration-200 ${medifarmaDropdownOpen ? 'rotate-180' : ''}`}
            ...
            <div className="flex items-center space-x-2">
              {/* Cart Button */}
              {showCartButton && (
                <Link to="/cart" className="text-gray-700 hover:text-blue-600 relative">              <ShoppingCart size={20} />
               {cartQuantity > 0 && (
          ...
          <div className="px-4 pt-4 pb-3 space-y-1">
            ...
            {isActive('/medifarma') && (
              <div className="pl-6 pt-2 pb-1 space-y-1">
                <h4 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Top Delivery Locations</h4>
                <div className="grid grid-cols-2 gap-2">
                  {deliveryLocations.slice(0, 4).map((location, index) => (
                    <Link 
                      key={index}
                      to={`/medifarma/location/${location.toLowerCase().replace(' ', '-')}`}
